...
public class CustomExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, HttpHeaders headers, HttpStatusCode status, WebRequest request) {
        ...
        final CustomerRequestErrorModel error = new CustomerRequestErrorModel(errors, CustomerErrorCodeConfig.INVALID_INPUT, ErrorSeverityLevelCodeType.ERROR);
    ...
    public ResponseEntity<Object> handleDataIntegrityViolationException(DataIntegrityViolationException ex) {
        ...
        final CustomerErrorModel error = new CustomerErrorModel(message, CustomerErrorCodeConfig.DB_ERROR, ErrorSeverityLevelCodeType.ERROR);
    ...
    public final ResponseEntity<Object> handleConstraintViolation(ConstraintViolationException ex) {
        final CustomerErrorModel error = new CustomerErrorModel(ex.getMessage(), CustomerErrorCodeConfig.DB_ERROR, ErrorSeverityLevelCodeType.ERROR);
        return new ResponseEntity<>(error, HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<Object> handleRuntimeException(RuntimeException ex) {
        final CustomerErrorModel error = new CustomerErrorModel(ex.getMessage(), CustomerErrorCodeConfig.INTERNAL_ERROR, ErrorSeverityLevelCodeType.ERROR);
    ...
    public ResponseEntity<Object> handleGlobalException(Exception ex) {
        final CustomerErrorModel error = new CustomerErrorModel(ex.getMessage(), CustomerErrorCodeConfig.GLOBAL_ERROR, ErrorSeverityLevelCodeType.ERROR);
        return new ResponseEntity<>(error, HttpStatus.BAD_REQUEST);
    }
