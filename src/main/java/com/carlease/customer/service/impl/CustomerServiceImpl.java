...
public class CustomerServiceImpl implements CustomerService {
  ...
  public CustomerResponse createCustomer(CustomerRequest customerRequest)
    ...
    CustomerDao existingCustomerDao =
        customerRepository.findByEmailAddress(customerRequest.getEmailAddress());
   ...
   */
  @Override
  public CustomerResponse getCustomerByCustomerId(Integer customerId)
  ...
  public List<CustomerResponse> getAllCustomerDetails(int page, int size) {
    ...
    return customerRepository
        .findAll(pageRequest)
        .map(customerDao -> customerMapper.mapCustomerDaoToCustomerResponse(customerDao))
        .getContent();
  }
  /**
