...
public class CustomerController {
    ...
    public ResponseEntity<CustomerResponse> createCustomer(@Valid @RequestBody CustomerRequest request) throws CustomerDuplicationException {
    ...
    public ResponseEntity<CustomerResponse> getCustomer(@Valid @PathVariable("id") Integer customerId) throws  CustomerNotFoundException {
    ...
    @ResponseStatus(HttpStatus.FOUND)
    public ResponseEntity<List<CustomerResponse>> geAllCustomer(@PathParam("page") Integer page, @PathParam("size") Integer size) {
    ...
    public ResponseEntity<CustomerResponse> updateCustomer(@Valid @RequestBody CustomerRequest request, @PathVariable("customerId") Integer customerId) throws  CustomerNotFoundException {
    ...
    public void delete(@PathVariable("customerId") Integer customerId) throws CustomerException, CustomerNotFoundException {
    ...
    @ResponseStatus(HttpStatus.OK)
    public ResponseEntity<CustomerResponse> updateCustomerStatus(@PathVariable("customerId") Integer customerId, @Valid @RequestBody CustomerStatusUpdateRequest updateStatusRequestModel) throws CustomerException, CustomerNotFoundException {
        logger.info("Modifying an existing customer");
        return ResponseEntity.ok(customerService.updateCustomerStatus(customerId, updateStatusRequestModel));
    }
